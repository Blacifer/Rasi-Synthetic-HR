...
const ROLE_COLORS: Record<string, string> = {
  viewer: 'text-gray-500 bg-gray-50 dark:bg-gray-900/30',
  manager: 'text-blue-600 bg-blue-50 dark:bg-blue-900/30',
  admin: 'text-orange-600 bg-orange-50 dark:bg-orange-900/30',
  super_admin: 'text-red-600 bg-red-50 dark:bg-red-900/30',
};
...
export const HumanReviewNode = memo(({ data, selected }: NodeProps<HumanReviewNodeData>) => (
  <div
    className={`bg-white dark:bg-gray-800 border-2 rounded-xl shadow-md px-4 py-3 min-w-[180px] max-w-[240px] ${
      selected ? 'border-green-500' : 'border-green-300 dark:border-green-700'
    }`}
  >
    ...
    <div className="flex items-center gap-2 mb-1">
      ...
      <span className="text-xs font-semibold text-green-700 dark:text-green-300 uppercase tracking-wide">Human Review</span>
    </div>
    <p className="text-sm font-medium text-gray-800 dark:text-gray-100 truncate">{data.label || 'Approval Gate'}</p>
